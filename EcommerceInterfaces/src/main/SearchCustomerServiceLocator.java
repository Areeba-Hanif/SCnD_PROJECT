...
public class SearchCustomerServiceLocator extends org.apache.axis.client.Service implements main.SearchCustomerService {
    ...
    private java.lang.String SearchCustomer_address = "http://localhost:8080/ECommerceWebsiteProject/services/SearchCustomer";
    ...
    public main.SearchCustomer getSearchCustomer() throws javax.xml.rpc.ServiceException {
    ...
    public main.SearchCustomer getSearchCustomer(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.SearchCustomerSoapBindingStub _stub = new main.SearchCustomerSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.SearchCustomer.class.isAssignableFrom(serviceEndpointInterface)) {
                main.SearchCustomerSoapBindingStub _stub = new main.SearchCustomerSoapBindingStub(new java.net.URL(SearchCustomer_address), this);
                _stub.setPortName(getSearchCustomerWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://main", "SearchCustomerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://main", "SearchCustomer"));
        }
