...
public class LoginServiceServiceLocator extends org.apache.axis.client.Service implements main.LoginServiceService {
    ...
    private java.lang.String LoginService_address = "http://localhost:8080/ECommerceWebsiteProject/services/LoginService";
    ...
    public main.LoginService getLoginService() throws javax.xml.rpc.ServiceException {
    ...
    public main.LoginService getLoginService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.LoginServiceSoapBindingStub _stub = new main.LoginServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.LoginService.class.isAssignableFrom(serviceEndpointInterface)) {
                main.LoginServiceSoapBindingStub _stub = new main.LoginServiceSoapBindingStub(new java.net.URL(LoginService_address), this);
                _stub.setPortName(getLoginServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://main", "LoginServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://main", "LoginService"));
        }
