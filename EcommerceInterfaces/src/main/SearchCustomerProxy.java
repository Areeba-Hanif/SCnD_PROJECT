...
public class SearchCustomerProxy implements main.SearchCustomer {
  private String _endpoint = null;
  private main.SearchCustomer searchCustomer = null;
  ...
  private void _initSearchCustomerProxy() {
    try {
      searchCustomer = (new main.SearchCustomerServiceLocator()).getSearchCustomer();
  ...
  public main.SearchCustomer getSearchCustomer() {
    if (searchCustomer == null)
      _initSearchCustomerProxy();
